...
class CameraCalib:
    ...
    def drawing(self, img, point_list, result_list):
        ...
        cv2.putText(img, 'X axis', (1000,470), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255,0,0), 2, cv2.LINE_AA)
        cv2.putText(img, 'Y axis', (1150,350), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0,255,0), 2, cv2.LINE_AA)
